...
import { SnipShort, CurrencyConverter, DiscordColorText, github, Portfolio, RockPaperSissors, Todo, YoutubeFeed, AIchat, FinanceTracker, Uniconnect, Baseliner, SecretSanta } from "../assets";
...
const projects = [

  {
    ...
    Deploy_link: "https://uniconnect-campus.vercel.app",
  },

  {
    name: "SnipShort",
    description:
      "Redis-Based Scalable URL Shortener for sub-millisecond redirects, containerized using Docker across frontend, backend, Redis, and MySQL, and deployed on AWS EC2.",
    tags: [
    ...
    image: SnipShort,
    source_code_link: "https://github.com/RulerDevansh/SnipShort_UrlShortner",
    Deploy_link: "https://snipshort.vercel.app",
  },

  {
    ...
    source_code_link: "https://github.com/RulerDevansh/Automated_Finance_Tracker",
